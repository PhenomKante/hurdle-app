...
export function BattleSection({ data, onChange }: Props) {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h3 className="text-lg font-semibold text-gray-800 mb-1">⚔️ The Battle</h3>
        <p className="text-sm text-gray-500">Address the struggle directly, without shame.</p>
      </div>
      ...
      <div>
        ...
        <p className="text-xs text-gray-500 mb-2">This question builds trust—answer honestly.</p>
        <textarea
