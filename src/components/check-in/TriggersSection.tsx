...
export function TriggersSection({ data, onChange }: Props) {
  return (
    <div className="space-y-6">
      <div>
        <h3 className="text-lg font-semibold text-gray-800 mb-1">🔍 Triggers & Patterns</h3>
        <p className="text-sm text-gray-500">Help identify what's driving the struggle.</p>
      </div>
        ...
        <div className="grid grid-cols-2 gap-3">
          {[
            ...
            >
              ...
              <div className={`font-medium ${data[key as keyof typeof data] ? 'text-indigo-700' : 'text-gray-700'}`}>
                {label}
              </div>
            </button>
          ))}
      ...
      <div>
        ...
        <p className="text-xs text-gray-500 mb-2">Celebrate these! They show growth. 🎉</p>
        <textarea
