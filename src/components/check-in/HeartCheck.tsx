...
export function HeartCheck({ data, onChange }: Props) {
  return (
    <div className="space-y-6">
      <div>
        <h3 className="text-lg font-semibold text-gray-800 mb-1">💜 Heart Check</h3>
        <p className="text-sm text-gray-500">How are you really doing this week?</p>
      </div>
      ...
      <div className="flex items-start gap-3">
        ...
        />
        <label htmlFor="scripture" className="text-sm text-gray-700">
