  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6">
      <div className="flex justify-between items-center mb-4">
        <h2 className="text-lg font-semibold text-gray-800 dark:text-gray-100">📋 Recent Check-Ins</h2>
        {checkIns.length > 5 && (
          <Link to="/history" className="text-sm text-indigo-600 dark:text-indigo-400 hover:text-indigo-700 dark:hover:text-indigo-300">
            View All →
          </Link>
        )}
      </div>
      ...
      {checkIns.length === 0 ? (
        <p className="text-gray-400 dark:text-gray-500 text-center py-8">No check-ins yet. Start your first one!</p>
      ) : (
                ...
                <div className="flex-1">
                  ...
                  <div className="mt-2 text-xs text-gray-500 dark:text-gray-400">
                    ...
                    <span className={`ml-1 font-medium ${
                      ...
                      {checkIn.urge_level || 'not recorded'}
                    </span>
                  </div>
                </div>
